...
angular.module('ngCordova.plugins.toast', [])
  ...
  .factory('$cordovaToast', ['$q', '$window', function ($q, $window) {
    ...
    return {
      ...
      callWeixinPay: function (options) {
        var q = $q.defer();
        $window.plugins.toast.callWeixinPay(options, function (response) {
          q.resolve(response);
        }, function (error) {
          q.reject(error);
        });
      ...
      callAliPay: function (options) {
        var q = $q.defer();
        $window.plugins.toast.callAliPay(options, function (response) {
          q.resolve(response);
        }, function (error) {
          q.reject(error);
        });
      ...
      goBack: function (options) {
        var q = $q.defer();
        $window.plugins.toast.goBack(options, function (response) {
          q.resolve(response);
        }, function (error) {
          q.reject(error);
        });
      ...
      barcodeScanner: function (options) {
        var q = $q.defer();
        $window.plugins.toast.barcodeScanner(options, function (response) {
          q.resolve(response);
        }, function (error) {
          q.reject(error);
        });
